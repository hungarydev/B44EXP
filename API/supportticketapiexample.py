...
entities = make_api_request(f'apps/68c4ad722707e9b7b8151d69/entities/SupportTicket')
print(entities)
...
def update_entity(entity_id, update_data):
    response = requests.put(
        f'https://app.base44.com/api/apps/68c4ad722707e9b7b8151d69/entities/SupportTicket/{entity_id}',
        headers={
            'api_key': 'e53a541d35c94df8aca8459c55437813',
            'Content-Type': 'application/json'
        },
